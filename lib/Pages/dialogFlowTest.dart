...
class _ChatState extends State<Chat> {
  ...
  Future<void> initPlugin() async {
    ...
    final serviceAccount = ServiceAccount.fromString(
        //'${(await rootBundle.loadString('lib/assets/andrew-dialogflow-vorp-9fa45d7fadb0.json'))}');
        '${(await rootBundle.loadString('lib/assets/credential.json'))}');
  ...
  void handleSubmitted(text) async {
    ...
    bool allParamSet = data.queryResult.allRequiredParamsPresent;
    ...
    if (allParamSet) {
      ...
      Map<String, Value> dateTimeInfo = data.queryResult.parameters.fields;
      // print("param: " + dateTimeInfo.toString());
      String date = dateTimeInfo["date"].toString().substring(13, 23);
      String time = dateTimeInfo["time"].toString().substring(23, 32);
      // print("date: " + date);
      // print("time: " + time);
      ...
      final event = new Event(
          ...
          endTime: startDateTime.add(Duration(hours: 2)));
      eventProvider.addEvent(userInfoProvider.userID,event);
    ...
    responseStream.listen((data) {
      ...
      setState(() {
        ...
        if (fulfillmentText.isNotEmpty) {
          ...
          _textController.clear();
          _messages.insert(0, botMessage);
          //print("bot Message:" + botMessage.toString());
        }
  ...
  List<Widget> otherMessage(context) {
    return <Widget>[
      new Container(
        ...
        child: CircleAvatar(child: new Text('A')),
      ),
      new Expanded(
        child: Column(
